...
<template>
    ...
    <div class="line">
        ...
        <Button label="Succes" color="succes"/>
    ...
    <div class="line">
        ...
        <Button label="Succes" color="succes" rounded/>
    ...
    <div class="line">
        ...
        <Button label="Succes" color="succes" outlined/>
    ...
    <div class="line">
        ...
        <Button color="succes" icon="address-book" outlined/>
